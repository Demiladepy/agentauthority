...
// ============================================================
// PERMISSION REQUEST / NEGOTIATION
// ============================================================
...
export type NegotiationResult = 
  | { outcome: 'granted'; authority: SpendingAuthority }
  | { outcome: 'counter_offer'; adjustedPolicy: SpendingPolicy; reason: string }
...
export type ValidationResult = 
  | { valid: true; remainingBudget: bigint; warningLevel: 'none' | 'low' | 'high' }
  | { valid: false; reason: string; code: ValidationErrorCode };
